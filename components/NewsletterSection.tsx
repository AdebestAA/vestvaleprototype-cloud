    ...
    <section ref={ref} className="py-16 bg-[#9d6b53] text-white" id="newsletter">
      ...
      >
        ...
        <p className="text-xl mb-6 max-w-2xl mx-auto">
          Receive exclusive access to new property listings, limited edition furnishings, and invitations to private
          viewings.
        </p>
        ...
        <form className="max-w-md mx-auto flex">
          <input
            ...
            className="flex-grow p-3 bg-white rounded-l text-[#9d6b53] focus:outline-none"
          />
          <button
            type="submit"
            className="bg-amber-800 hover:bg-amber-900 px-6 py-3 rounded-r font-medium transition"
          >
            Subscribe
          </button>
        </form>
